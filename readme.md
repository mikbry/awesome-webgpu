...
- [Yapmap](https://yapmap.cc) - Free voice-controlled photoreal 3D world map; an AI guide flies the WebGPU globe (WebGL2 fallback), dives into 3D terrain, drops pins and narrates each place. No signup.

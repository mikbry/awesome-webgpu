...
- [RunMat](https://runmat.com) - Open-source GPU-accelerated numerical computing runtime. Runs MATLAB-syntax .m files in the browser via WASM + WebGPU with automatic GPU fusion. - [Repository](https://github.com/runmat-org/runmat)

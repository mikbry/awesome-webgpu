...
- [Milo](https://milo.seemplifyai.com/) - Three.js voice companion demonstrating local Qwen inference on compatible browser WebGPU adapters with a CPU switch, by [Michael Egbo](https://github.com/michaelegbo) - [Repository](https://github.com/michaelegbo/milo) (PolyForm Noncommercial).

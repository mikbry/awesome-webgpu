...
- [EmberEngine Games](https://endersgamesdev.github.io/EmberEngine/) - Four playable multiplayer web games (first-person arena shooter, drift racer, four-corner chess, 3D pong) on a Rust/wgpu engine, WebGPU with WebGL2 fallback - [Repository](https://github.com/EndersGamesDev/EmberEngine)
